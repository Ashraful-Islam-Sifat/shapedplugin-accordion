...
const Edit = ({
  ...
  const iconFromContext = context['shapedplugin-accordion/icon'];
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Title', 'shapedplugin-accordion'),
    tagName: "h4",
    value: title,
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('task-block/shapedplugin-accordion-item', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Accordion Item', 'shapedplugin-accordion'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('An Accordion Item', 'shapedplugin-accordion'),
...
function dynamicCss(attributes) {
  ...
  let desktopCss = {
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item`]: {
      'margin-bottom': itemsGap + 'px'
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__title`]: {
      'background-color': titlleBgColor,
      'padding': `${titlePadding.top} ${titlePadding.right} ${titlePadding.bottom} ${titlePadding.left}`
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__title:hover`]: {
      'background-color': titleBgHover
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__title .accordion__title-text`]: {
      'color': titlleTextColor,
      'text-align': titleTextAlingment,
      'font-family': titleFontFamily
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__title:hover .accordion__title-text`]: {
      'color': titleTextHover
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__content`]: {
      'background-color': contentBgColor,
      'padding': `${contentPadding.top} ${contentPadding.right} ${contentPadding.bottom} ${contentPadding.left}`
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__content:hover`]: {
      'background-color': contentHoverBgColor
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId}  .accordion__item .accordion__title .accordion__arrow`]: {
      'order': iconPosition,
      'color': iconColor
    },
    [`.wp-block-task-block-shapedplugin-accordion-${uniqueId} .accordion__item .accordion__title:hover .accordion__arrow`]: {
...
const Edit = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TabPanel, {
    className: "shapedplugin-accordion-tab-panel",
    activeClass: "shapedplugin-accordion-active-tab",
    onSelect: tabName => setActiveTab(tabName),
    activeTab: activeTab,
    tabs: [{
      name: 'general',
      title: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "shapedplugin-accordion-tab-panel-title"
      ...
      })), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('General', 'shapedplugin-accordion')),
      ...
      title: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        ...
        clipRule: "evenodd"
      })), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Styles', 'shapedplugin-accordion')),
    ...
    className: "shapedplugin-accordion-tabs-content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Gap between accordion items', 'shapedplugin-accordion'),
    value: itemsGap,
    onChange: value => setAttributes({
      itemsGap: value
    }),
    ...
    className: "shapedplugin-accordion-sidebar-label-text"
  }, "Title Text Align"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "shapedplugin-accordion-button-group"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: `shapedplugin-accordion-sidebar-button ${titleTextAlingment == "left" ? 'active-button' : ''}`,
    ...
    className: `shapedplugin-accordion-sidebar-button ${titleTextAlingment == "center" ? 'active-button' : ''}`,
    onClick: () => setAttributes({
    ...
    className: `shapedplugin-accordion-sidebar-button ${titleTextAlingment == "right" ? 'active-button' : ''}`,
    onClick: () => setAttributes({
    ...
    className: `shapedplugin-accordion-sidebar-button ${iconPosition == "1" ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      iconPosition: "1"
    })
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Choose an icon', 'shapedplugin-accordion'),
    value: icon,
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Title', 'shapedplugin-accordion'),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Font Family', 'shapedplugin-accordion'),
    value: titleFontFamily,
    options: fontFamilyOptions,
    onChange: newValue => setAttributes({
      titleFontFamily: newValue
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "shapedplugin-accordion-sidebar-label-text"
    ...
    className: `shapedplugin-accordion-sidebar-button ${titleBgType === 'default' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      titleBgType: "default"
    })
  }, "Default"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: `shapedplugin-accordion-sidebar-button ${titleBgType === 'hover' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      titleBgType: "hover"
    })
    ...
    colorSettings: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Background', 'shapedplugin-accordion'),
      value: titlleBgColor,
      onChange: value => {
        setAttributes({
          titlleBgColor: value
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Text', 'shapedplugin-accordion'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Padding', 'shapedplugin-accordion'),
    values: titlePadding,
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Icon', 'shapedplugin-accordion'),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "shapedplugin-accordion-sidebar-label-text"
    ...
    className: `shapedplugin-accordion-sidebar-button ${iconColorType === 'default' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      iconColorType: "default"
    })
  }, "Default"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: `shapedplugin-accordion-sidebar-button ${iconColorType === 'hover' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      iconColorType: "hover"
    })
    ...
    disableCustomColors: false,
    colorSettings: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Color', 'shapedplugin-accordion'),
      value: iconColor,
      onChange: value => {
        setAttributes({
          iconColor: value
    ...
    disableCustomColors: false,
    colorSettings: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Hover Color', 'shapedplugin-accordion'),
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Content', 'shapedplugin-accordion'),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "shapedplugin-accordion-sidebar-label-text"
    ...
    className: `shapedplugin-accordion-sidebar-button ${contentBgType === 'default' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      contentBgType: "default"
    })
  }, "Default"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: `shapedplugin-accordion-sidebar-button ${contentBgType === 'hover' ? 'active-button' : ''}`,
    onClick: () => setAttributes({
      contentBgType: "hover"
    })
    ...
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
      className: `wp-block-task-block-shapedplugin-accordion-${uniqueId}`
    })
    ...
    allowedBlocks: ['task-block/shapedplugin-accordion-item'],
    orientation: "vertical",
    template: [['task-block/shapedplugin-accordion-item'], ['task-block/shapedplugin-accordion-item'], ['task-block/shapedplugin-accordion-item']]
  })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"task-block/shapedplugin-accordion","version":"0.1.0","title":"ShapedPlugin Accordion","category":"media","icon":"editor-kitchensink","description":"An accordion block","example":{},"supports":{"html":false,"align":["wide","full"]},"attributes":{"itemsGap":{"type":"number","default":10},"frontendCss":{"type":"string","default":""},"uniqueId":{"type":"string"},"titleBgType":{"type":"string","default":"default"},"titleBgHover":{"type":"string","default":"#c4c4c4"},"titlleBgColor":{"type":"string","default":"#C4C4C4"},"titleTextHover":{"type":"string","default":""},"titlleTextColor":{"type":"string","default":"#000000"},"titleFontFamily":{"type":"string","default":""},"contentBgType":{"type":"string","default":"default"},"contentBgColor":{"type":"string","default":"#f3f3f3"},"contentHoverBgColor":{"type":"string","default":""},"titleTextAlingment":{"type":"string","default":"left"},"iconPosition":{"type":"string","default":"1"},"iconColorType":{"type":"string","default":"default"},"iconColor":{"type":"string","default":"#fff"},"iconHoverColor":{"type":"string","default":""},"titlePadding":{"type":"object","default":{"top":"8px","left":"13px","right":"13px","bottom":"8px"}},"contentPadding":{"type":"object","default":{"top":"10px","left":"10px","right":"10px","bottom":"10px"}},"icon":{"type":"string","default":"fas fa-chevron-down"},"iconSize":{"type":"string"}},"providesContext":{"shapedplugin-accordion/icon":"icon"},"textdomain":"shapedplugin-accordion","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
