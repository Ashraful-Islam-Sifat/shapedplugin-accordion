<?php
/**
 * Plugin Name:       ShapedPlugin Accordion
 ...
 * Text Domain:       shapedplugin-accordion
 *
 * @package CreateBlock
 */
...
function task_block_shapedplugin_accordion_block_init() {
...
add_action( 'init', 'task_block_shapedplugin_accordion_block_init' );